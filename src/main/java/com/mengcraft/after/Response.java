...
public class Response {
	public final static String FILE_STATUS_OKEY = "150 File status okay; about to open data connection\r\n";
	...
	public final static String FILE_STATUS_DONE = "226 Closing data connection\r\n";
	...
	public final static String FILE_ACT_NOT_TAKEN = "450 Requested file action not taken\r\n";
	...
	public final static String CMD_BAD_SEQUENCE = "503 Bad sequence of commands\r\n";
